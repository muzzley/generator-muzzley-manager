...
module.exports = {
  ...
  structure: function () {    
    ...
    this.dest.mkdir('production');
    this.dest.mkdir('production/logrotate');    
    this.dest.mkdir('production/upstart');
    this.dest.mkdir('production/_template');    
    ...
    this.swig('production/_upstart.conf', 'production/_template/manager-'+this.swigVars.lname+'_upstart.conf');
    this.swig('production/_logrotate', 'production/_template/manager-'+this.swigVars.lname+'_logrotate');     
